            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-sm-4 col-md-4 col-5"> <a href="{{ route('inicio') }}" class="brand-wrap"
                            data-abc="true">
                            <img src="\imagenes\Logo.png" alt="logo" width="80" height="80" class="top_bar_icon"><span
                                class="logo">AutoAssistant</span></img></a> </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="option-box mr-2">
                                    <a class="nav-link nav-user-img small" href="{{ route('welcome') }}">
                                        <span class="register"><em class='bx bx-user'></em>{{ Auth::user()->name }}</span>
                                    </a>
                                </div>
                                <span class="vl"></span>
        ...
        <nav class="navbar navbar-expand-md navbar-main border-bottom">
            ...
            <div class="navbar-collapse collapse" id="dropdown6" style="">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('servicios-mecanicos.indexinterno')}}">Búsqueda de servicios<em
                         class='bx bx-search-alt'></em></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="infoServicioWeb">Requisitos<em
                         class='bx bx-list-check'></em>
                        </a>
                    </li>
