...
<main class="">
        ...
        <aside class="filters">
            ...
            <form id="buscarForm">
                <label>
                    <input type="checkbox" name="rubro[]" value="Mecanico" onchange="buscarServicios()"> Mecánico
                </label>
                <label>
                    <input type="checkbox" name="rubro[]" value="Electronico" onchange="buscarServicios()"> Eléctrico
                </label>
                <label>
        ...
        <div class="grid row justify-content-center background-image">
